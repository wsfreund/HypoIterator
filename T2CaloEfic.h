...
class T2CaloEfic : public Efic {
	...
	//Corte
	PCUTS applyCuts(const float eta, const float phi, const float eta0, const float phi0, const float rCore, const float F1, const float eRatio, const float eT_T2Calo, const float hadET_T2Calo);
